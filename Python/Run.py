...
def run():
	...
	while True:
		...
		cv2.putText(frame, "-IntelliGate Virtual Door-", (10, H - ((i * 20) + 200)),
		...
		for (i, (k, v)) in enumerate(info2):
			text = "{}: {}".format(k, v)
			cv2.putText(frame, text, (230, H - ((i * 20) + 60)), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
            
		text = 'Intelligate - RPACULT Hackathon'
		cv2.putText(frame, text, (230, H - ((i * 20) + 20)), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
